...
[下载 DSH Desktop v1.0.7](https://github.com/rw0104/DSH-desktop/releases/tag/v1.0.7) · [直接下载 Windows 安装器](https://github.com/rw0104/DSH-desktop/releases/download/v1.0.7/DSH-Desktop-1.0.7-x64-Setup.exe)
...
1. 从 [v1.0.7 Release](https://github.com/rw0104/DSH-desktop/releases/tag/v1.0.7) 下载 Windows x64 安装器。
2. 选择安装目录并完成安装。
