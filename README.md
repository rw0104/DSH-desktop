...
当前源码版本为 **2.2.1**：在 Harness `0.1.2-rc.1` 和 Better Sidebar `0.18.0` 基础上修复实时语音按钮灰显和模型图片能力传输。热修复说明及自定义模型图片配置见 [v2.2.1 更新说明](docs/releases/v2.2.1.md)，运行时升级内容见 [v2.2.0](docs/releases/v2.2.0.md)。新版本下载资产发布前，上方链接仍指向已发布的 v2.1.0。
