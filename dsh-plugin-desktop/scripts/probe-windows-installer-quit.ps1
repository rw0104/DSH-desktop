...
try {
  ...
  $taskStartInfo.ArgumentList.Add("--user-data-dir=$taskUserData")
  ...
  $taskQuitStartInfo.ArgumentList.Add("--user-data-dir=$taskUserData")
  $taskQuitStartInfo.ArgumentList.Add('--dsh-desktop-installer-quit')
