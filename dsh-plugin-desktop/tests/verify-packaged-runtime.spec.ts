...
describe('packaged desktop runtime verification', () => {
  it('rejects any removed Vision Toolkit entry from the official package', () => {
    expect(() => verifyRemovedProductBundles(new Set([
      'package.json',
      'node_modules/@anionex/dsh-vision-toolkit/package.json',
    ]))).toThrow('packaged runtime contains removed Vision Toolkit entries')
    expect(() => verifyRemovedProductBundles(new Set(['package.json']))).not.toThrow()
  })
