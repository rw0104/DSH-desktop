export const zh = {
  ...
  scanningInstallableBody: '首次检查会同步当前来源的完整目录，可能需要几秒钟。完成后这里会自动显示结果。',
  ...
  builtIn: '内置适配器',
  partner: '合作提供方',
  partnerSourceDescription: '合作提供方目录。需要您明确添加并选择；目录收录不代表插件经过审核或推荐。',
  partnerSourceAttribution: '目录数据由合作提供方提供。',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  scanningInstallableBody: 'The first check synchronizes the complete catalog and may take several seconds. Results appear here automatically when it finishes.',
  ...
  partnerSourceDescription: 'Partner catalog. You must add and select it explicitly; inclusion is not an audit or endorsement.',
  partnerSourceAttribution: 'Catalog data is provided by a partner provider.',
