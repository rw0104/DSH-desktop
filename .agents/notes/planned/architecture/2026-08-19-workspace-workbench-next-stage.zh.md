...
Status: active; W0、W1、W2、W3.1、W3.2 核心已完成；下一步为 W3.3
...
| W3 | W3.1 inspect 与 W3.2 managed create/remove 核心已完成；setup scripts、handoff 待实现 | 两个 Session 可在独立 worktree 并行并安全交接 |
