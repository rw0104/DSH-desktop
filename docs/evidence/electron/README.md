...
| `advanced-sidebar-collapsed-default.png` | Windows advanced mode with a fresh DSH Home | Better Sidebar is mounted but collapsed by default; native caption controls remain clear of the sidebar cluster |
