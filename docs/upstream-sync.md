...
| --- | --- | --- | --- | --- |
| 官方 Harness | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | `master` / `dsh-v0.1.1-rc.2`，commit `b150a551b8d465e31e418e1b2eaf5e79bbb7d28e`；npm `latest` `0.1.1-rc.2` | 子模块 `dsh-v0.1.0-rc.8`，commit `141eb6fef83422698aef7a981029e843e8161534`；桌面依赖为 `0.1.0-rc.8` | 待本轮兼容迁移和回归后升级 |
| 官方侧栏 | [omdsh-dev/DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar) | `main` / `v0.15.1`，commit `ef8d3a90505f90e15e810d35d8c9c14bc6894fdb`；npm `latest` `0.15.1` | `dsh-better-sidebar@0.14.0` + `.yarn/patches/` 审计 patch | 待随 rc2 peer 基线验证后升级 |
| 桌面参考 | [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | `master` commit `6201080cfaa2f9b0864333e9da695cde71d3f1e1`，根 package `2.0.2` | 本 fork `rw0104/DSH-desktop` 的 `v2.0.7` | 仅作 Electron/打包对照，不作为运行时依赖 |
...
- 兼容性门槛：`corepack yarn install --immutable`、typecheck、完整 unit/check、Loader/Profile smoke、Windows packaged smoke 和 installer verifier 全部通过后才允许发布。
